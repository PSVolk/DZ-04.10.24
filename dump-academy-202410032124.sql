...
INSERT INTO `departaments` VALUES (1,1000000.00,'Бурение','1',0),(2,1500000.00,'Разработка и эксплуатация месторождений','1',0),(3,2000000.00,'Разработка программного обеспечения','1',0),(4,2500000.00,'Моделирование процессов (лаборатория)','1',0);
...
INSERT INTO `faculties` VALUES (1,'Ахметшин Ильшат','Горно-нефтяной факультет'),(2,'Венера Фамильева','Технологический факультет'),(3,'Лютов Егор','Факультет цифоровых систем'),(4,'Настя Ивлеева','Факультет трубопроводного транспорта'),(5,'Волков Павел','Архитектурно-строительный факультет'),(6,'Валитов Руслан','Факультет заочного обучения');
...
INSERT INTO `groups1` VALUES (1001,'ГБ-01-03','5','5','1'),(1002,'ГБ-02-03','4','4','1'),(1003,'ГБ-03-03','3','3','1'),(1004,'ГБ-04-03','2','2','1'),(1005,'ГБ-05-03','1','1','1'),(1006,'ГБ-05-02','1','1','1');
...
INSERT INTO `teachers` VALUES (10001,'2015-01-20',_binary '\0',_binary '','Ильшат','Преподаватель',100000.00,200000.00,'Ахметшин'),(10002,'2015-02-20',_binary '',_binary '\0','Егор','Преподаватель',150000.00,210000.00,'Лютов'),(10003,'2016-03-20',_binary '',_binary '\0','Настя','Преподаватель',160000.00,220000.00,'Ивлева'),(10004,'2020-04-20',_binary '',_binary '\0','Венера','Преподаватель',100000.00,150000.00,'Галиева'),(10005,'2025-05-20',_binary '\0',_binary '','Павел','Преподаватель',100000.00,200000.00,'Волков'),(10006,'2020-09-20',_binary '',_binary '\0','Руслан','Преподаватель',110000.00,205000.00,'Валитов');
